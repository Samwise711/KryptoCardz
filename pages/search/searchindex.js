...
class SearchIndex extends Component {
  ...
  static async getInitialProps(props) {  // static allows one to run class function without creating an instance!!
    ...
    */
    ...
    const searchTerm = (props.query.term).toLowerCase();
